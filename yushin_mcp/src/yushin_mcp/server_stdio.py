"""MCP stdio server entrypoint for yushin-mcp.

Run with:
    python3 -m yushin_mcp.server_stdio
...
yushin_agent --mode live — can discover and call forensic tools over
